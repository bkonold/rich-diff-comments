# Microsoft Edge Add-ons submission — v1.11.0
...
v1.11.0 makes conversations inside tables and fenced code easier to locate, adds Copy link to every rendered comment, and removes redundant bulk-render prompts after Markdown is already rendered. No new permissions or host permissions were added.
...
- **Zip:** `rdc-1.11.0.zip` (in this folder)
...
Includes all changes from v1.11.0, v1.10.0, and v1.9.0.
