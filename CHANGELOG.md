...
- **The sidebar starts collapsed.** The first time you open a pull request, you see the compact controls in GitHub's toolbar instead of a floating panel. Expand it with the ☰ button or `t`; the extension remembers your choice. Pressing `Shift+T` to reset the layout still opens the full sidebar.
