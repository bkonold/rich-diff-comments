...
- `npm test` — 409 Node:test unit/static tests (no browser). Run before every commit touching JS.
- `npm run test:e2e` / `npm run test:e2e:github` — 21 GitHub fixture tests in headless Chromium.
- `npm run test:e2e:ado` — 62 ADO Preview + mocked REST fixture tests in headless Chromium.
